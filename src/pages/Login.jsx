...
const Login = () => {
  return (
    <div className="w-full flex justify-center items-center max-w-full py-3 sm:max-w-xl sm:mx-auto shadow-xl mt-28 md:flex-0 shrink-0">
    <div className="relative z-0 flex flex-col min-w-0 break-words bg-white border-0 shadow-soft-xl rounded-2xl bg-clip-border">
      <div className="p-6 mb-0 text-center bg-white border-b-0 rounded-t-2xl">
        <h5 className="text-xl font-bold">Log In</h5>
      </div>
      ...
      <p className="mt-4 mb-0 leading-normal text-sm">or didn't have any account? <span className="font-semibold"><Link to="/sign_up">SIGN UP</Link></span></p>
       </form>
      </div>
    </div>
    </div>
